            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class='row'>
                        ...
                        @foreach($subbanners['data'] as $index => $banner)

                            <div id="{{ $banner['id'] }}" class='subbanner-item col col-md-6 col-lg-4'>    
                                <div class="banner-card card shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <table class='table'>
                                                ...
                                                <td colspan='2'>
                                                    <div class='input-group'>
                                                        ...
                                                        <div class='input-group-append'>
                                                            <button class='btn btn-sm btn-primary subbanner-save-button'>
                                            ...
                                            <tr>
                                                <th>Əməliyyat</th>
                                                <td class='text-right'><button class='btn btn-sm btn-danger subbanner-delete-button'><i class='fas fa-trash'></i></button></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class='text-center'>
                                ...
                                <nav class='d-inline-block'>
                                    <ul class="pagination p-0 m-0">
                                        ...
                                        @foreach($subbanners['links'] as $link)
